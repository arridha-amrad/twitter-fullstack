  ...
  return (
    <div className="h-40 px-5 font-medium">
      {menu.map((m, i) => (
        <a
          key={i}
          className="mr-3 text-sm text-gray-500 dark:text-slate-400 hover:underline"
          href={m.link}
          target="_blank"
        >
          {m.name}
      ...
      <button className="mr-3 text-sm text-gray-500 cursor-pointer dark:text-slate-400 hover:underline">
        More...
      </button>
